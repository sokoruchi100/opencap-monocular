    ...
    try:
        ...
        try:
            ...
            raise HTTPException(
                status_code=422,
                detail={
                    "error": "Video rejected: insufficient full-body 2D keypoints",
                    "error_type": "InsufficientFullBodyKeypointsError",
                    "message": str(e),
                    "stage": "WHAM_preprocess",
                    "suggestion": "Use a clip where the full body is visible; hand-only or heavily occluded views are not supported.",
                },
            )
