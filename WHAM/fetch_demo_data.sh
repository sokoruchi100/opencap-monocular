...
wget --post-data "username=$username&password=$password" 'https://download.is.tue.mpg.de/download.php?domain=smpl&sfile=SMPL_python_v.1.1.0.zip' -O './dataset/body_models/smpl.zip' --no-check-certificate --continue
unzip dataset/body_models/smpl.zip -d dataset/body_models/smpl
mv dataset/body_models/smpl/SMPL_python_v.1.1.0/smpl/models/basicmodel_f_lbs_10_207_0_v1.1.0.pkl dataset/body_models/smpl/SMPL_FEMALE.pkl
mv dataset/body_models/smpl/SMPL_python_v.1.1.0/smpl/models/basicmodel_m_lbs_10_207_0_v1.1.0.pkl dataset/body_models/smpl/SMPL_MALE.pkl
mv dataset/body_models/smpl/SMPL_python_v.1.1.0/smpl/models/basicmodel_neutral_lbs_10_207_0_v1.1.0.pkl dataset/body_models/smpl/SMPL_NEUTRAL.pkl
